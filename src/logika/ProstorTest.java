...
public class ProstorTest
{
    ...
    public void testVeci()
    {
 		...
 		Vec vec1 = new Vec("aaa", "popis bla", false);
        Vec vec2 = new Vec("bbb", "popis blabla", true);
        Prostor prostor1 = new Prostor("mistnost1", "prosturek");
        prostor1.vlozVec(vec1);
        prostor1.vlozVec(vec2);
		prostor1.vlozVec(vec2);
		assertEquals(vec1, prostor1.najdiVec("aaa"));
		assertEquals(true, prostor1.odeberVec("aaa"));
